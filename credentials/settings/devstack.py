...
if str2bool(os.environ.get('ENABLE_DJANGO_TOOLBAR', False)):
    INSTALLED_APPS += [
        'debug_toolbar',
    ]
...
# TODO Pull edxapp public/private host and port
...
SOCIAL_AUTH_EDX_OIDC_URL_ROOT = os.environ.get('SOCIAL_AUTH_EDX_OIDC_URL_ROOT', 'http://edxapp:18000/oauth2')
